...
public class NoticeController {
	 ...
	 * 处理/login请求
	 * */
	@RequestMapping(value="/notice/selectMyNotice")
	 public String selectMyNotice(Model model,Integer pageIndex,
			 @ModelAttribute Notice notice){
		PageModel pageModel = new PageModel();
		if(pageIndex != null){
			pageModel.setPageIndex(pageIndex);
	...
	@RequestMapping(value="/notice/addNotice")
	 public ModelAndView addNotice(
		...
		if(flag.equals("1")){
			...
			Admin admin = (Admin) session.getAttribute(HrmConstants.ADMIN_SESSION);
