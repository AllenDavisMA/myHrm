		...
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx}/js/metronic/img/profile/1.jpg" alt="">
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									value="${password}"><br>
									<input type="radio" name="identity" id="identity" value="employee" checked />&nbsp;<font color = "white">员工</font>
									<input type="radio" name="identity" id="identity" value="manager"/>&nbsp;<font color = "white">经理</font>
									<input type="radio" name="identity" id="identity" value="admin"/>&nbsp;<font color = "white">管理员</font>
							</div>
						</div>
					</div>
				</div>
