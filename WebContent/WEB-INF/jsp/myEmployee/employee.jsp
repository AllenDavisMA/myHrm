	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
	    					   // alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${ctx }/myEmployee/removeEmployee?ids=" + ids.get();
	    				   }
	    			   });
	    		   }
	    	   })
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${ctx}/employee/selectMyEmployee">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	职位：
					  ...
					  <tr>
					    <td class="font3">
					    	...
					    	所属部门： <input type = "hidden" name = "dept_id" id = "dept_id" value = "${sessionScope.manager_session.dept_id } "> 
					    	${requestScope.depts.get(sessionScope.manager_session.dept_id - 1).name } 
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${sessionScope.myEmployees}" var="employee" varStatus="stat">
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 ...
					 <td>${employee.password }</td>
					  ...
					  <td align="center" width="40px;"><a href="${ctx}/myEmployee/updateEmployee?flag=1&id=${employee.id}">
