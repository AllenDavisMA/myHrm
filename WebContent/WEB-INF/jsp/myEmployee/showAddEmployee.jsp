...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/myEmployee/addEmployee" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr>
				<td class="font3 fftd">
					...
					&nbsp;&nbsp;所属部门：
					<input type = "hidden" name = "dept_id" id = "dept_id" value = "${sessionScope.manager_session.dept_id }">
